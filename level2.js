...
function showL2Intro() {
  ...
  ov.querySelector('.box').innerHTML =
    ...
    '<p class="keys keysTouch">Джойстик слева — ходьба · ⚔️ — удар · ✋ — действие/меню · ' +
    'долгое нажатие — меню действий · 🗺 — карта и задание (мир замирает) · иконки внизу — котомка</p>' +
    '<p class="keys keysTouch" style="font-style:italic;opacity:.75;font-size:11.5px;">' +
    'Игра идёт и на телефоне, но оптимизирована под компьютеры — рекомендуем играть там.</p>' +
